 ...
 * @author User
 */
public class FlappyBird1 implements ActionListener, KeyListener {
    ...
    public void go() {
        ...
        panel = new GamePanel1(this, bird, rects);
        frame.add(panel);
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!paused) {
            ...
            scroll++;
             if(scroll==2000){
                JOptionPane.showMessageDialog(null, "Level 2 Is Successfully Completed......");
                paused=true;
                new FlappyBird2().go();
            }
