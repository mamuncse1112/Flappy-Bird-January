...
public class GamePanel2 extends JPanel {
    ...
    public GamePanel2(FlappyBird2 fb2, Bird bird, ArrayList<Rectangle> rects) {
        this.fb2 = fb2;
        this.bird = bird;
        this.rects = rects;
    ...
    public void paintComponent(Graphics g) {
        g.setColor(bg);
        g.fillRect(0,0,FlappyBird2.WIDTH,FlappyBird2.HEIGHT);
        bird.update(g);
        ...
        g.drawString("Score: "+fb2.getScore(), 10, 20);
        
        if(fb2.paused()) {
            g.setFont(pauseFont);
            g.setColor(new Color(0,0,0,170));
            g.drawString("PAUSED", FlappyBird2.WIDTH/2-100, FlappyBird2.HEIGHT/2-100);
            g.drawString("PRESS SPACE TO BEGIN", FlappyBird2.WIDTH/2-300, FlappyBird2.HEIGHT/2+50);
        }
    }
}
